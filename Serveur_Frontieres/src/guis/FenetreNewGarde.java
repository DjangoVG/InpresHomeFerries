...
import SecurityCrypto.DigestSaltPassword;
...
public class FenetreNewGarde extends javax.swing.JFrame {
    ...
    public FenetreNewGarde(Socket SocketClient, ObjectInputStream Objectis, ObjectOutputStream Objectos) {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelPanel.setText("Ajout d'un nouveau garde");
    ...
    private void BoutonCreerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BoutonCreerActionPerformed
        DigestSaltPassword dsp = new DigestSaltPassword();
        String password1;
        String password2;
        ...
        if (password1.equalsIgnoreCase(password2))
        {
            ...
            try
            {
                req = new RequeteCINAP(0, TextNewUser.getText(), dsp.DigestSaltPassword(password1).toString());
                oos.writeObject(req);
                
                reponse = (ReponseCINAP)ois.readObject();

                if (reponse.getCode() == ReponseCINAP.NEWUSER_OK)
                {
                        String msg;
            ...
            { Logger.getLogger(FenetreNewGarde.class.getName()).log(Level.SEVERE, null, ex); }
        }
        else
        {
            TextNewPwd.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenetreNewGarde.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FenetreNewGarde(null, null, null).setVisible(true);
            }
        });
    }

...
public class ReponseVERIFIDS implements Reponse, Serializable
{   
    private int code;
    ...
    /* Constructeurs */
    public ReponseVERIFIDS(int c, byte [] NumeroNational, byte [] NumeroPermis, byte [] Nom, byte [] Prenom, byte [] DateNaissance, byte [] DateMaxValiditeIdentite, byte [] DateMaxValiditePermis )
    {
        code =c;
    ...
    public ReponseVERIFIDS(int c, byte [] NumeroNational, byte [] Nom, byte [] Prenom, byte [] DateNaissance, byte [] DateMaxValiditeIdentite)
    {
        code =c;
        this.NumeroNational = NumeroNational;
        this.Nom = Nom;
    ...
    public ReponseVERIFIDS (int c)
    {
        code =c;
    }
    public ReponseVERIFIDS(int c, DefaultTableModel dtmdl)
    {
        code =c;
        dm = dtmdl;
    }
    public ReponseVERIFIDS(int c, DefaultTableModel dtmdl,DefaultTableModel dtmdl2)
    {
        code =c;
        dm = dtmdl;
        dm2 = dtmdl2;
    }
    public ReponseVERIFIDS(int c, DefaultTableModel dtmdl, int TailleBloc)
    {
        code =c;
        dm = dtmdl;
    }
    
    public ReponseVERIFIDS(int c, DefaultTableModel dtmdl, DefaultTableModel dtmdl2, int TailleBloc)
    {
        code =c;
        dm = dtmdl;
        dm2 = dtmdl2;
    ...
    public ReponseVERIFIDS(int c, byte [] dtmdl, int TailleBloc)
    {
        code =c;
        this.bytDLM = dtmdl;
    ...
    public ReponseVERIFIDS(int c, byte [] dtmdl, byte [] dlm2, int TailleBloc)
    {
        code =c;
        this.bytDLM = dtmdl;
        this.bytDLM2 = dlm2;
     ...
     public ReponseVERIFIDS(int c, DefaultTableModel dlm, byte [] ByteSignature)
    {
        code =c;
        this.dm = dlm;

...
<link rel="stylesheet" type="text/css" href="css/main.css">
        ...
        %>
            ...
            <%
                ...
                <div id="features" class="text-center">
                   <div class="section-title" data-aos="fade-down" id="Acheter">
                    <h2>NOS Traversées</h2>
                    <h3>Attention : Les réductions des LastMinutes sont déjà appliquées sur les prix affichés !</h3>
                </div>
                                        ...
                                        <table>
                                            <thead>
                                                <tr align="center" class="row100 head">
                                                    ...
                                                    <th class="cell100 column5">Matricule</th>
                                                    <th class="cell100 column6">Prix</th>
                                                    <th class="cell100 column7">LastMinute</th>
                                                    <th class="cell100 column6">Tickets</th>
                                                    <th class="cell100 column8">Ajouter</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        %>
                                                            <tr class="row100 body">
                                                                ...
                                                                <td class="cell100 column5"><%=traversee.getPrix()%>€</td>
                                                                <td class="cell100 column6"><%=LastMinute%></td>
                                                                <td class="cell100 column6"><input type ="number" id="number"/></td>
                                                                <td class="cell100 column8"><a href="AjoutPanier?IdTraversee=<%=traversee.getIdTraversees()%>" 
                                                                    <form role="form" method="post" action="AjoutPanier?value=<%=traversee.getIdTraversees()%>"><img src="img/edit.png" width="25px" height="25px"></a>
                                                                    </form>
                                                                </td>
                                                            </tr>
                                                        <%}%>
    ...
    {
            String redirectURL = "LoginHome.jsp#FormCheckLogin";
            request.setAttribute("demande", "0");

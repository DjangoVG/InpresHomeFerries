...
public class FenetreLogin extends javax.swing.JDialog {
    ...
    private Applic_datamining fenetreClient;
    ...
    public FenetreLogin(java.awt.Frame parent, boolean modal, Applic_datamining fenetreclient, Socket SocketClient) {
    ...
    private void ConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConnectActionPerformed
        ...
        else
        {
            ...
            try 
            {
                ...
                req = new RequeteANASTAT(0, this.TextFieldUsername.getText(), this.TextNumClient.getText());

                this.oos.writeObject(req);
                System.out.println("Jenvoi la demande de connexion");

                reponse = (ReponseANASTAT)this.ois.readObject();
                ...
                if (reponse.getCode() == 1)
                {
                    ...
                    fenetreClient.RequeteA.setEnabled(true);
                    fenetreClient.RequeteB.setEnabled(true);
                    fenetreClient.RequeteC.setEnabled(true);
                    fenetreClient.RequeteD.setEnabled(true);
                    fenetreClient.RequeteE.setEnabled(true);
                    fenetreClient.RequeteF.setEnabled(true);
                    fenetreClient.RequeteG.setEnabled(true);
                    this.dispose();
                }
                else
                {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FenetreLogin dialog = new FenetreLogin(new javax.swing.JFrame(), true, null, null);

...
import PoolDeThreads.ThreadUrgent;
...
public class FenetreLogin extends javax.swing.JDialog implements Serializable
{

    private VerificateurUsersPasswordHash Sub;
    private FenClient fenetreClient;
    ...
    private ThreadUrgent tu;
    
    public FenetreLogin(java.awt.Frame parent, boolean modal, FenClient fenetreclient, Socket SocketClient) {
    ...
    private void ConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConnectActionPerformed
        ...
        else
        {
            ...
            try 
            {
                ...
                req = new RequeteCINAP(4, this.TextFieldUsername.getText(), this.TextMotDePasse.getText(), 3);

                this.oos.writeObject(req);
                System.out.println("Jenvoi la demande de connexion");

                reponse = (ReponseCINAP)this.ois.readObject();
                
                if (reponse.getCode() == ReponseCINAP.LOGIN_OK)
                {
                    tu = new ThreadUrgent(fenetreClient);
                    tu.start();
                    System.out.println("Lancement du thread urgent");
                    ...
                    fenetreClient.BoutonAcheterTicket.setEnabled(true);
                    fenetreClient.BoutonVerifReservation.setEnabled(true);

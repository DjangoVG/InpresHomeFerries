...
public class FenetreLoginAdmin extends javax.swing.JDialog implements Serializable
{

    private VerificateurUsersPasswordHash Sub;
    private FenAdmin fenetreClient;
    ...
    public FenetreLoginAdmin(java.awt.Frame parent, boolean modal, FenAdmin fenetreAdmin, Socket SocketClient) {
        
        super(parent, modal);
        cliSock = SocketClient;
        initComponents();
        setTitle("Login de l'application de Home-Ferries");
        fenetreClient = fenetreAdmin;
    ...
    private void initComponents() {
        ...
        BoxServeur = new javax.swing.JComboBox<>();
        ...
        BoxServeur.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Serveur Java", "Serveur C" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(BoxServeur, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(107, 107, 107)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(BoxServeur, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void ConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConnectActionPerformed
        ...
        if (BoxServeur.getSelectedItem().toString().equalsIgnoreCase("Serveur Java"))
        {
            ...
            else
            {
                ...
                try 
                {
                    cliSock = new Socket(propServeur.getProperty("adresse"), Integer.valueOf((String) propServeur.getProperty("portEcouteAdmin")));
                    ...
                    if (reponse.getCode() == ReponseHAFICSA.LOGIN_OK)
                    {
                        ...
                        fenetreClient.BoutonListeClients.setEnabled(true);
                        fenetreClient.BoutonPauseServeur.setEnabled(true);
                        fenetreClient.BoutonStopServeur.setEnabled(true);
                        this.dispose();
                    }
                    else
                    {
        ...
        else
        {
            ...
            else
            {
                ...
                try 
                {
                    cliSock = new Socket(propServeur.getProperty("adresse"), Integer.valueOf((String) propServeur.getProperty("portEcouteC")));
                    ...
                    String Message = TextFieldUsername.getText() + ";" + TextMotDePasse.getText();

                    dos.write(Message.getBytes());
                    System.out.println("Jenvoi la demande de connexion à Serveur Terminaux");

                    String Reponse = dis.readUTF();

                    if (Reponse.equalsIgnoreCase("LOGIN_OK"))
                    {
                        fenetreClient.MenuSeDeconnecter.setEnabled(true);
                        fenetreClient.MenuSeConnecter.setEnabled(false);
                        fenetreClient.BoutonQuitter.setEnabled(false);
    ...
    private javax.swing.JComboBox<String> BoxServeur;
